...
namespace ExitGames
{
	namespace Common
	{
		namespace TypeCode
		{
			...
			static const nByte PHOTON_COMMAND     = 'p'; /**<internal only*/// used for photon commands
			...
			static const nByte UNKNOWN            = 0  ; /**<internal only*/// used instead of OBJECT for values inside an Dictionary
		}

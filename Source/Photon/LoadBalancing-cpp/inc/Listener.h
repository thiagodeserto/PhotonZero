...
namespace ExitGames
{
	namespace LoadBalancing
	{
		...
		public:
			...
			virtual void disconnectEventAction(int playerNr) = 0;
			...
			virtual void onLobbyStatsResponse(const Common::JVector<LobbyStats>& lobbyStats) {}
			...
			virtual void onLobbyStatsUpdate(const Common::JVector<LobbyStats>& lobbyStats) {}

	...
	namespace LoadBalancing
	{
		...
		*/
		namespace DisconnectCause
		{
			...
			static const int TIMEOUT_DISCONNECT = 5;
			...
			static const int INVALID_AUTHENTICATION = 7;
			...
			static const int MAX_CCU_REACHED = 8;
			...
			static const int INVALID_REGION = 9;
			...
			static const int OPERATION_NOT_ALLOWED_IN_CURRENT_STATE = 10;
			...
			static const int CUSTOM_AUTHENTICATION_FAILED = 11;
		}
	}
}